      ...
      <article className="max-w-[var(--article-max-width)] mx-auto px-4 py-6">
        ...
        <div className="info-box">
          <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
            ...
            Sicherheits-Checkliste der TV-Investorin:
          </h3>
        ...
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-6 my-8">
          <p className="text-sm mb-4">
            <strong>Anmerkung der Redaktion:</strong> Die bekannte TV-Investorin hat uns gebeten, ihren persönlichen Zugang zu teilen. Er ist nicht öffentlich auf der Bank-Website verfügbar.
          </p>
          <OfferButton className="w-full">
            Geheimtipp der TV-Investorin nutzen →
          </OfferButton>
